...
def encode_features():
    ...
    **NOTE : You can modify the encode_featues function used in heart disease's inference
    ...
    store_data_to_db(constants.DB_PATH ,constants.DB_FILE_NAME, X, 'features')
    store_data_to_db(constants.DB_PATH ,constants.DB_FILE_NAME, y, 'target')
...
def get_trained_model():
    ...
    with mlflow.start_run(run_name=constants.EXPERIMENT) as mlrun:
        #Model Training
